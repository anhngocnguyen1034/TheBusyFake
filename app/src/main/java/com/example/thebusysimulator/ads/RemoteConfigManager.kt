...
/**
 * Điều khiển quảng cáo từ xa qua Firebase Remote Config: bật/tắt ads, cooldown giữa 2
 * interstitial, và map từng vị trí (ad_name) sang ad_unit_id thật. Chưa cấu hình →
 * fallback về test unit của Google theo định dạng, nên app luôn chạy được kể cả khi
 * chưa gắn Remote Config thật.
 */
object RemoteConfigManager {
    ...
    fun init(context: Context) {
        val settings = remoteConfigSettings {
            // Debug: fetch ngay khi gọi. Release: cache ~1h.
